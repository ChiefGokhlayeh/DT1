...
deb0: entity work.DEBOUNCE
      port map(clk => clk, orig => buttons(0), debounced => buttons_entprellt(0));

deb1: entity work.DEBOUNCE
      port map(clk => clk, orig => buttons(1), debounced => buttons_entprellt(1));

deb2: entity work.DEBOUNCE
      port map(clk => clk, orig => buttons(2), debounced => buttons_entprellt(2));

deb3: entity work.DEBOUNCE
      port map(clk => clk, orig => buttons(3), debounced => buttons_entprellt(3));
