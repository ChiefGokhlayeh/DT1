...
-- main state machine
--------------------------------------------------------------------------
main_seq: process (clk, reset_n) is
begin
  if reset_n = '0' then
     -- reset condition
...
--------------------------------------------------------------------------
column_seq: process (clk, reset_n) is
begin
  if reset_n = '0' then
     -- reset condition
...
--------------------------------------------------------------------------------------------------
column_init_seq: process (clk, reset_n) is
begin
  if reset_n = '0' then
     -- reset condition
...
issue_seq: process (clk, reset_n) is
begin
  if reset_n = '0' then
     -- reset condition
...
--------------------------------------------------------------------------------------------------
lcd_init_seq: process (clk, reset_n) is
begin
  if reset_n = '0' then
     -- reset condition
...
--------------------------------------------------------------------------------------------------
lcd_write_char_seq: process (clk, reset_n) is
begin
  if reset_n = '0' then
     -- reset condition
...
-- wait state machine
--------------------------------------------------------------------------
wait_seq: process (clk, reset_n) is
begin
  if reset_n = '0' then
     -- reset condition
    wait_state <= 0; 
...
--------------------------------------------------------------------------
check_BF_seq: process (clk, reset_n) is
begin
  if reset_n = '0' then
     -- reset condition
